...
I'm **Tevin Nyabuti Mokaya** — a software engineering student at Co-operative University of Kenya (2023–present). I build mobile and full-stack products: React Native, Kotlin, TypeScript, and Supabase.
...
- Web apps and admin dashboards (React, TypeScript)
...
`TypeScript` `React` `React Native` `Expo` `Kotlin` `Supabase` `PostgreSQL` `Git`
